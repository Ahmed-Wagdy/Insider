...
Rails.application.config.assets.precompile += %w( tweeterAnalysis.js )
Rails.application.config.assets.precompile += %w( drawCharts.js )
Rails.application.config.assets.precompile += %w( sentimentAnalysis.js )
Rails.application.config.assets.precompile += %w( getTweets.js )